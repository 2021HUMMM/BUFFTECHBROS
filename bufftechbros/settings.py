"""
Django settings for bufftechbros project.
...
CSRF_TRUSTED_ORIGINS = [
    "https://bufftechbros-production.up.railway.app"
]

ROOT_URLCONF = 'bufftechbros.urls'
...
WSGI_APPLICATION = 'bufftechbros.wsgi.application'
